...
class DDS(BrStruct):
    ...
    def __br_read__(self, br: BinaryReader):
        ...
        self.header = br.read_struct(DDS_Header)
...
class DDS_Header(BrStruct):
    def __init__(self):
        self.size = 124
        self.flags = None
        self.height = None
        self.width = None
        self.pitchOrLinearSize = None
        self.depth = None
    ...
    def __br_read__(self, br: BinaryReader):
        ...
        self.pixel_format = br.read_struct(DDS_PixelFormat)
    ...
    def __br_write__(self, br: 'BinaryReader', dds1):
        ...
        br.write_struct(DDS_PixelFormat(), dds1.pixel_format)
...
class DDS_PixelFormat(BrStruct):
    def __init__(self):
        self.size = 32
        self.flags = None
        self.fourCC = None
    ...
    def __br_write__(self, br: 'BinaryReader', dds2):
...
class DDS_DX10_Header(BrStruct):
    ...
    def __br_write__(self, br: 'BinaryReader', dds3):
